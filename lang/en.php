...
$_package = "Package";
$_password = "Password";
$_please_login = "Welcome, Please Login";
...
<li>For filters per month, select Day and month, then click Filter.<br>
	...
	<li>Filter based on '.$_comment.', fill in !!'.$_comment.' in the  column, then click filter. Or click one of the comments. (GoldenWifi Online).</li>
